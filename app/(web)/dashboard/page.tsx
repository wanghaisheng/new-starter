  ...
  return (
    <div className="flex min-h-screen flex-col p-6">
      <header className="flex justify-between items-center mb-8 border-b pb-4">
        <h1 className="text-2xl font-bold"{t('auto.page.Web')}/h1>
      ...
      <main className="flex-grow">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
            <h2 className="text-xl font-semibold mb-4"{t('auto.page.')}/h2>
            <p className="text-3xl font-bold">1,234</p>
            <p className="text-green-500 mt-2"{t('auto.page.12')}/p>
          </div>
          
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
            <h2 className="text-xl font-semibold mb-4"{t('auto.page.')}/h2>
            <p className="text-3xl font-bold">¥9,876</p>
            <p className="text-green-500 mt-2"{t('auto.page.8')}/p>
          </div>
          
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
            <h2 className="text-xl font-semibold mb-4"{t('auto.page.')}/h2>
            <p className="text-3xl font-bold">87%</p>
            <p className="text-red-500 mt-2"{t('auto.page.3')}/p>
          </div>
