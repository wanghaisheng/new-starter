...
import {
  IonPage, IonHeader, IonToolbar, IonTitle, IonContent, IonButton, IonFooter, IonIcon, IonImg, IonToast, IonSpinner
} from '@ionic/react';
    ...
    <IonPage>
      <IonHeader>
        <IonToolbar color="primary">
          <IonTitle{t('auto.setup_photos.')}/IonTitle>
        </IonToolbar>
      </IonHeader>
      <IonContent className="ion-padding bg-gradient-to-br from-slate-900 to-slate-800 min-h-screen">
        <div className="glass-card rounded-2xl p-6 w-full max-w-md mx-auto mt-10">
          <div className="text-center mb-6">
            <h2 className="text-xl font-bold text-white mb-2"{t('auto.setup_photos.')}/h2>
            <p className="text-slate-400"{t('auto.setup_photos.2')}/p>
          </div>
